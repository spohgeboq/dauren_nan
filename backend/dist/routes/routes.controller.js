...
let RoutesController = class RoutesController {
    ...
    updatePointStatus(routeId, pointId, status) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], RoutesController.prototype, "updateRouteStatus", null);
__decorate([
    (0, common_1.Patch)(':routeId/points/:pointId/status'),
    __param(0, (0, common_1.Param)('routeId', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('pointId', common_1.ParseIntPipe)),
