...
exports.RecipesModule = RecipesModule = __decorate([
    (0, common_1.Module)({ controllers: [recipes_controller_1.RecipesController], providers: [recipes_service_1.RecipesService], exports: [recipes_service_1.RecipesService] })
], RecipesModule);
